...
const TCHAR ProductNames::PRODUCT_NAME[] = _T("BaoVNC");
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("BaoVNC Server");

const TCHAR RegistryPaths::SERVER_PATH[] = _T("Software\\BaoVNC\\Server");
const TCHAR RegistryPaths::SERVER_REVERSE_CONN_HISTORY_PATH[] =
  _T("Software\\BaoVNC\\Control\\ReverseConnectionHistory");
const TCHAR RegistryPaths::DISPATCHER_CONN_HISTORY_PATH[] =
  _T("Software\\BaoVNC\\Control\\DispatcherConnectionHistory");
...
const TCHAR LogNames::LOG_DIR_NAME[] = _T("BaoVNC");
...
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("BaoVNC Server");
...
const TCHAR DefaultNames::DEFAULT_COMPUTER_NAME[] = _T("BaoVNC Server");


const char HttpStrings::HTTP_INDEX_PAGE_FORMAT[] =
"<HTML>\n"
"  <HEAD><TITLE>BaoVNC desktop [%.256s]</TITLE></HEAD>\n"
"  <BODY>\n"
...
"%.1024s"
"    </APPLET><BR>\n"
"    <A HREF=\"http://www.tightvnc.com/\">www.BaoVNC.com</A>\n"
"  </BODY>\n"
"</HTML>\n";

const char HttpStrings::HTTP_MSG_BADPARAMS[] =
"<HTML>\n"
"  <HEAD><TITLE>BaoVNC desktop</TITLE></HEAD>\n"
"  <BODY>\n"
